...
export const INVITATION_CONTENT = {
  ...
  0: {
    ...
    subtitle: null,
    message:
      "Under the glow of love and surrounded by those they cherish most, Willfred and Carla invite you to celebrate the day their hearts become one. Share in the laughter, happy tears, and beautiful memories as they begin a lifetime of togetherness.",
...
export const ROLE_MAP = {
  ...
  "Coin Bearer": 11,
  "Bible Bearer": 12,
  "Father of the Bride": 13,
  "Mother of the Bride": 14,
  "Father of the Groom": 15,
  "Mother of the Groom": 16,
};